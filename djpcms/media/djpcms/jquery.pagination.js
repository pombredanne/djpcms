 ...
 *
 * Original from Gabriel Birke (birke *at* d-scribe *dot* de)
 * 
 * Adapted for use with djpcms
 */
(function($) {
	$.fn.pagination = function(maxentries, opts){
		...
		opts = $.extend({
			...
			info: function() {
				var p = this.current_page+1;
				return "Displaying page " + p + " of " + maxentries + " entries";
			}
		},opts||{});
