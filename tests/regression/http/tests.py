...
class HttpTests(test.TestCase):
    ...
    def testRequest(self):
        request = self.http.Request({'PATH_INFO': 'bogus', 'REQUEST_METHOD': 'bogus', 'wsgi.input': http.BytesIO(b'')})
    ...
    def test_stream(self):
        request = http.Request({'REQUEST_METHOD': 'POST', 'wsgi.input': StringIO('name=value')})
