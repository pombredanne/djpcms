...
from djpcms import Route, IDREGEX


class TestRoute(test.TestCase):
    ...
    def testSimple(self):
        ...
        r = Route('bla') + Route('foo')
        self.assertEqual(str(r),'^bla/foo/$')
        self.assertEqual(r.path,'/bla/foo/')
        
    def testAppendSlashFalse(self):
        r = Route('bla', append_slash = False)
        self.assertEqual(str(r),'^bla')
        self.assertEqual(r.path,'/bla')
        r2 = Route('foo')
        ...
        r4 = Route('//foo//') + Route('///bla///', append_slash = False)
    ...
    def testVariablesAppendSlashFalse(self):
        ...
        #
        r2 = Route('(?P<path>[\w./-]*)',append_slash = False)
